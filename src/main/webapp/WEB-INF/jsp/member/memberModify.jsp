...
// 취소버튼
function backPage() {
	location.href='/weekrep/weekrepList.do';
	};
// 모달닫기
function closeModal() {
	 $('#passForm')[0].reset();
					     	 ...
					     	 <div class="dataTable-container">
                     	    	<form role="form" id="memModiForm" method="post" autocomplete="off">
		                     	   <div class="form-group">
									  ...
									  <button type="button" onclick="javascript:openModal();"  data-toggle="modal" class="btn btn-outline-primary">비밀번호변경</button>
									</div>
								    <div class="form-group">
        ...
        <div class="modal-body">
	        <form role="form" id="passForm" method="post" autocomplete="off">
		        ...
		        <input type="hidden" id="memId" name="memId" value="${member.memId }"/>
					...
					<div class="form-group">
				      <label for="userPass" class="form-label mt-4">Password</label>
				      <input type="password" class="form-control" name="userPass" id="userPass">
				    </div>	
					<div class="form-group">
				      <label for="userPass_chk" class="form-label mt-4">Password</label>
				      <input type="password" class="form-control" name="userPass_chk" id="userPass_chk">
				    </div>	
			 </form>
		</div>
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-primary" onclick="javascript:fn_memPassModify();">수정</button>
          <button type="button" class="btn btn-outline-primary" onclick="javascript:closeModal();">취소</button>
        </div>
      </div>
